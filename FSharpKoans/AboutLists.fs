...
module ``05: I Have Here In My Hand A List`` = 
    ...
    let ``13 Pattern-matching a list (Part 9).`` () =
        ...
        let k =
            ...
            | _::t::_::u::_ -> t + u
            | _ -> "fig"
        k |> should equal "peachwatermelon" //adding strings or rather appending
    ...
    let ``14 Creating a list containing a sequence of numbers, and indexing`` () =
        ...
        let l = [3..3..20]
       // let j = [0..2..10]
        k.[3] |> should equal 9 // steps to the next number using 1
        l.[3] |> should equal 12 //steps to the next number using a scale of 3
       // j.[1] |> should equal 2